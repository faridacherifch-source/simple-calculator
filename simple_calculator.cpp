...
float n3 ,n4;//float the division numbers as high chance they contain decimals
 int n1 , n2 , result=0;//int the first and second number as they are used for the operations that most likely wont contain decimals
...
cin>>angle;
double radians = angle * M_PI / 180.0;
result3= 1/sin(radians);//one over the function to obtain its the inverse
cout<<"result= "<<result3<<endl;}
else if (function==5){
cout<<"please input your desired angle: ";
cin>>angle;
double radians = angle * M_PI / 180.0;
result3= 1/cos(radians);
cout<<"result= "<<result3<<endl;}
else if (function==6){
cout<<"please input your desired angle: ";
cin>>angle;
double radians = angle * M_PI / 180.0;
result3= 1/tan(radians);
cout<<"result3= "<<result<<endl;}}
else if(function==8){
cout<<"1)ln"<<endl<<"2)log10"<<endl<<"3)log(custom base)"<<endl<<"please select your desired function: ";
cin>>function;
if(function==1){
...
cout<<"please input desired number: ";
cin>>n4;
result2 = log(n4) / log(n3);//in order for the user to select custom base use this formula
cout<<"result: "<<result2<<endl;}}
else ;
}
while (function!=0);
